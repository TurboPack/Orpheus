...
// (DO NOT EDIT: machine generated header) 'ovcmisc.pas' rev: 33.00 (Windows)
...
extern DELPHI_PACKAGE System::Byte __fastcall GetShiftFlags();
...
extern DELPHI_PACKAGE bool __fastcall IsForegroundTask();
