...
// (DO NOT EDIT: machine generated header) 'OvcTCHeaderExtended.pas' rev: 32.00 (Windows)
...
public:
	TOvcTCColHeadExtendedInfoItem* operator[](int Index) { return this->Items[Index]; }
