...
// (DO NOT EDIT: machine generated header) 'ovcexcpt.pas' rev: 31.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EOvcException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EOvcException(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOvcException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOvcException(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ENoTimersAvailable(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ENoTimersAvailable(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ENoTimersAvailable(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EControllerError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EControllerError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EControllerError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EControllerError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ENoControllerAssigned(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EControllerError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ENoControllerAssigned(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EControllerError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ENoControllerAssigned(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EControllerError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ECmdProcessorError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ECmdProcessorError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ECmdProcessorError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ECmdProcessorError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EDuplicateCommand(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ECmdProcessorError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EDuplicateCommand(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ECmdProcessorError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDuplicateCommand(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ECmdProcessorError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ETableNotFound(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ECmdProcessorError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ETableNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ECmdProcessorError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ETableNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ECmdProcessorError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EEntryFieldError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EEntryFieldError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EEntryFieldError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EEntryFieldError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidDataType(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidDataType(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidDataType(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EEntryFieldError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EInvalidPictureMask(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EEntryFieldError(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidPictureMask(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidPictureMask(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidPictureMask(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EEntryFieldError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EInvalidRangeValue(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EEntryFieldError(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidRangeValue(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidRangeValue(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidRangeValue(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EEntryFieldError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidDateForMask(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidDateForMask(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EEntryFieldError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidDateForMask(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EEntryFieldError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EEditorError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EEditorError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EEditorError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EEditorError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidLineOrCol(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EEditorError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidLineOrCol(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EEditorError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidLineOrCol(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EEditorError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidLineOrPara(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EEditorError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidLineOrPara(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EEditorError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidLineOrPara(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EEditorError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EViewerError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EViewerError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EViewerError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EViewerError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ERegionTooLarge(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EViewerError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ERegionTooLarge(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EViewerError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ERegionTooLarge(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EViewerError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ENotebookError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ENotebookError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ENotebookError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ENotebookError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidPageIndex(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ENotebookError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidPageIndex(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ENotebookError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidPageIndex(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ENotebookError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidTabFont(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ENotebookError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidTabFont(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ENotebookError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidTabFont(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ENotebookError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ERotatedLabelError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ERotatedLabelError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ERotatedLabelError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ERotatedLabelError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidLabelFont(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ERotatedLabelError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidLabelFont(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ERotatedLabelError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidLabelFont(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ERotatedLabelError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ETimerPoolError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ETimerPoolError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ETimerPoolError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ETimerPoolError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidTriggerHandle(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ETimerPoolError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidTriggerHandle(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ETimerPoolError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidTriggerHandle(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ETimerPoolError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EVirtualListBoxError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EVirtualListBoxError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EVirtualListBoxError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EVirtualListBoxError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EOnSelectNotAssigned(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EVirtualListBoxError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOnSelectNotAssigned(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EVirtualListBoxError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOnSelectNotAssigned(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EVirtualListBoxError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EOnIsSelectedNotAssigned(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EVirtualListBoxError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOnIsSelectedNotAssigned(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EVirtualListBoxError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOnIsSelectedNotAssigned(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EVirtualListBoxError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	__fastcall EReportViewError(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy);
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EReportViewError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EReportViewError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EReportViewError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EUnknownView(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EUnknownView(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EUnknownView(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EUnknownView(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EItemNotFound(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EItemNotFound(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EItemNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EItemNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EItemAlreadyAdded(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EItemAlreadyAdded(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EItemAlreadyAdded(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EItemAlreadyAdded(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EUpdatePending(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EUpdatePending(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EUpdatePending(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EUpdatePending(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EItemIsNotGroup(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EItemIsNotGroup(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EItemIsNotGroup(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EItemIsNotGroup(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall ELineNoOutOfRange(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ELineNoOutOfRange(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ELineNoOutOfRange(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ELineNoOutOfRange(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall ENotMultiSelect(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ENotMultiSelect(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ENotMultiSelect(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ENotMultiSelect(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EItemNotInIndex(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EItemNotInIndex(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EItemNotInIndex(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EItemNotInIndex(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall ENoActiveView(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ENoActiveView(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ENoActiveView(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ENoActiveView(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EOnCompareNotAsgnd(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EOnCompareNotAsgnd(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOnCompareNotAsgnd(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOnCompareNotAsgnd(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EGetAsFloatNotAsg(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EGetAsFloatNotAsg(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EGetAsFloatNotAsg(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EGetAsFloatNotAsg(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* EReportViewError.CreateFmt */ inline __fastcall EOnFilterNotAsgnd(int ErrorCode, const System::TVarRec *Args, const int Args_High, System::Byte Dummy) : EReportViewError(ErrorCode, Args, Args_High, Dummy) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EOnFilterNotAsgnd(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOnFilterNotAsgnd(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EReportViewError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOnFilterNotAsgnd(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EReportViewError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ESparseArrayError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ESparseArrayError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ESparseArrayError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ESparseArrayError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ESAEAtMaxSize(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : ESparseArrayError(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ESAEAtMaxSize(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ESparseArrayError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ESAEAtMaxSize(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ESparseArrayError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ESAEAtMaxSize(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ESparseArrayError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ESAEOutOfBounds(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : ESparseArrayError(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ESAEOutOfBounds(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : ESparseArrayError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ESAEOutOfBounds(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : ESparseArrayError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ESAEOutOfBounds(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : ESparseArrayError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EFixedFontError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFixedFontError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFixedFontError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFixedFontError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidFixedFont(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EFixedFontError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidFixedFont(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EFixedFontError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidFixedFont(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EFixedFontError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidFontParam(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EFixedFontError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidFontParam(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EFixedFontError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidFontParam(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EFixedFontError(Msg, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EMenuMRUError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : EOvcException(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EMenuMRUError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EMenuMRUError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : EOvcException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EMenuMRUError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : EOvcException(Msg, Args, Args_High, AHelpContext) { }
