...
VERSION = BCB.05.03
# ---------------------------------------------------------------------------
PROJECT = O406_r51.bpl
OBJFILES = AllOr.obj O406_r51.obj
RESFILES = O406_r51.res
MAINSOURCE = O406_r51.cpp
RESDEPEN = $(RESFILES)
LIBFILES =
IDLFILES =
IDLGENFILES =
...
LIBPATH = $(BCB)\lib\release;$(BCB)\Projects\Lib;$(BCB)\lib\obj;$(BCB)\lib
...
RFLAGS =
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower Orpheus 4.06 runtime package - VCL51" " -aa -Tpp -Gpr -x -Gn -Gl -Gi
# ---------------------------------------------------------------------------
