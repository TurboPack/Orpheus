...
VERSION = BCB.05.03
# ---------------------------------------------------------------------------
PROJECT = O406bd51.bpl
OBJFILES = OvcDbAE0.obj OvcDbAE1.obj OvcDbAE2.obj OvcDbAe3.obj OvcDbHBD.obj \
    Ovcdbtb0.obj OvcDbTb1.obj OvcRegBD.obj OvcRegDb.obj O406bd51.obj
RESFILES = O406bd51.res
MAINSOURCE = O406bd51.cpp
RESDEPEN = $(RESFILES)
LIBFILES =
IDLFILES =
IDLGENFILES =
LIBRARIES =
PACKAGES = vcl50.bpi vclx50.bpi vcldb50.bpi vclbde50.bpi O406BR51.bpi o405_r51.bpi \
    O406_d51.bpi
...
RFLAGS =
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower Orpheus 4.06 data-aware designtime package - VCL51" " -aa -Tpp -Gpd -x \
    -Gn -Gl -Gi
# ---------------------------------------------------------------------------
