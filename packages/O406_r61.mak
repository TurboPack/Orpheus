...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = O406_r61.bpl
OBJFILES = O406_r61.obj allor.obj
RESFILES = O406_r61.res
MAINSOURCE = O406_r61.cpp
RESDEPEN = $(RESFILES)
LIBFILES =
IDLFILES =
IDLGENFILES =
...
INCLUDEPATH = ..\..\BCB6\CBuilder6\Projects;$(BCB)\include;$(BCB)\include\vcl
LIBPATH = ..\..\bcb6\cbuilder6\lib\release;..\..\BCB6\CBuilder6\Projects;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
...
CFLAG1 = -Od -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- -c \
    -tWM
IDLCFLAGS = -I..\..\BCB6\CBuilder6\Projects -I$(BCB)\include -I$(BCB)\include\vcl \
    -src_suffix cpp -DBCB -boa
PFLAGS = -$YD -$W -$O- -$A8 -v -JPHNE -M
RFLAGS =
AFLAGS = /mx /w2 /zd
LFLAGS = -D"TurboPower Orpheus 4.06 runtime package - VCL61" " -aa -Tpp -Gpr -x -Gn -Gl \
    -Gi -v
# ---------------------------------------------------------------------------
