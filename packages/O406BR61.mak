...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = O406BR61.bpl
OBJFILES = O406BR61.obj allordb.obj
RESFILES = O406BR61.res
MAINSOURCE = O406BR61.cpp
RESDEPEN = $(RESFILES)
LIBFILES =
IDLFILES =
IDLGENFILES =
LIBRARIES = bcb2kaxserver.lib indy.lib dbxcds.lib dclocx.lib soaprtl.lib \
    bcbie.lib nmfast.lib dbexpress.lib inetdbxpress.lib inetdbbde.lib \
    bcbsmp.lib dsnapcon.lib dsnapcrba.lib visualdbclx.lib teeqr.lib dss.lib \
    tee.lib teedb.lib teeui.lib qrpt.lib bdecds.lib cds.lib ibxpress.lib \
    vcldbx.lib adortl.lib
PACKAGES = rtl.bpi vcl.bpi vclx.bpi dbrtl.bpi vcldb.bpi bdertl.bpi O406_r61.bpi
SPARELIBS = rtl.lib vcl.lib vcldb.lib adortl.lib bdertl.lib vcldbx.lib ibxpress.lib \
    ...
    dbxcds.lib indy.lib bcb2kaxserver.lib O406_r61.lib
DEFFILE =
OTHERFILES =
# ---------------------------------------------------------------------------
...
LIBPATH = ..\DBIsam\BCB6\lib;$(BCB)\lib\release;$(BCB)\Projects\Lib;$(BCB)\lib\obj;$(BCB)\lib;$(BCB)\Source\ToolsAPI
...
RFLAGS =
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower Orpheus 4.06 data-aware runtime package - VCL61" " -aa -Tpp -Gpr -x \
    -Gn -Gl -Gi
# ---------------------------------------------------------------------------
